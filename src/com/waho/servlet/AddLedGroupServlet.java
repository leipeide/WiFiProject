...
/**
 * Servlet implementation class AddLedGroupServlet
 */
@WebServlet("/addLedGroupServlet")
public class AddLedGroupServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddLedGroupServlet() {
        super();
