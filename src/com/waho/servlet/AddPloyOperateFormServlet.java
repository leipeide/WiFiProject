...
/**
 * Servlet implementation class AddPloyOperateFormServlet
 */
@WebServlet("/addPloyOperateFormServlet")
public class AddPloyOperateFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddPloyOperateFormServlet() {
        super();
