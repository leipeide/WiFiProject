	...
	<form class="layui-form">
		...
		<div class="layui-form-item" style="margin-top:10px;">
			...
			<div class="layui-input-block">
				<input type="checkbox" name="switchState"  id="checkBox" lay-skin="switch">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="i18n" style="width:180px;margin-left:25px;" name="EnterDimPara"></label>
			<div class="layui-input-block">
				<input class="layui-input" id="text1" type="text" name="lux"  placeholder="1-60000"
					required lay-verify="required" style="width:180px;margin-top:10px"
					autocomplete="off" onchange="percentCheck(this)">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
				<a class="layui-btn layui-btn-sm" 
					onclick="submitBtn('${pageContext.request.contextPath }/nodeInGroupLuxDimServlet',${nodeid })">
