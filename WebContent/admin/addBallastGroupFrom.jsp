...
<body>
		...
		<div class="layui-form-item">
			...
			<div style="width:120px;float:right;margin-right:60px;margin-top:0px;">
				<input id="text1" type="text" name="newName" required lay-verify="required" 
					autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
				<a class="layui-btn layui-btn-sm" lay-submit lay-filter="" style="margin-left: 10px;"
					onclick="submitBtn('${pageContext.request.contextPath }/addBallastGroupServlet',${userid })">
	...
	<script type="text/javascript" 
 	...
 	<script type="text/javascript">
		...
		function submitBtn(url,userid){
			var groupName = jQuery("#text1").val(); 
